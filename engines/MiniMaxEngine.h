...
inline void MiniMaxEngine::minimax_root(Board *bord, bool maximize, Action *moveOut, ActionList *moveList) {
...
inline double MiniMaxEngine::minimax(Board* bord, double alpha, double beta, int currentDepth, bool maximizing_player, bool whitePlays, bool doNullPruning) {
